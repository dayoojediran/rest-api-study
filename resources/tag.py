...
from resources.schemas import TagSchema, TagAndItemsSchema
...
class Tag(MethodView):
    ...
    def delete(self, tag_id):
        ...
        abort(400, message="Could not delete tag. Make sure tag is not accociated with any item, then try again.")
